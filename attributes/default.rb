...
default['redisio']['servers'] = [
  default['redisio']['default_settings'].merge(name: 'server1', port: '6379'),
  default['redisio']['default_settings'].merge(name: 'server2', port: '6380'),
  default['redisio']['default_settings'].merge(name: 'server3', port: '6381'),
  default['redisio']['default_settings'].merge(name: 'server4', port: '6382'),
  default['redisio']['default_settings'].merge(name: 'server5', port: '6383')
]
